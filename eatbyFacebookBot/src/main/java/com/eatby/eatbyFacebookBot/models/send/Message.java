package com.eatby.eatbyFacebookBot.models.send;

import com.google.gson.Gson;
import com.eatby.eatbyFacebookBot.Main;
...
import static com.eatby.eatbyFacebookBot.Main.sAccessToken;
...
public class Message {
    ...
    public Response sendTo(String recipientId) throws IOException {
        ...
        if (code == 200) {
        	System.out.println("(if)code = " + code);
